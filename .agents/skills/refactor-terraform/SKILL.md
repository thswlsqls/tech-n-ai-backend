...
핵심은 "무엇을 바꾸는가"가 아니라 **AGENTS.md 의 4대 행동 지침을 매 단계 강제하는 절차**이며,
특히 다음 둘을 어기지 않는다.
