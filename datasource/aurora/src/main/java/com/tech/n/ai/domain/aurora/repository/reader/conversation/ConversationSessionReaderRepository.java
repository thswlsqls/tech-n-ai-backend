package com.tech.n.ai.domain.aurora.repository.reader.conversation;
...
public interface ConversationSessionReaderRepository extends JpaRepository<ConversationSessionEntity, Long> {
    ...
    Page<ConversationSessionEntity> findByUserIdAndIsDeletedFalse(String userId, Pageable pageable);
